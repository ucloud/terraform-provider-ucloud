...
func dataSourceUCloudAntiDDoSInstancesRead(d *schema.ResourceData, meta interface{}) error {
	...
	var allInstances []sdkuads.ServiceInfo
	var instances []sdkuads.ServiceInfo
...
func dataSourceUCloudAntiDDoSInstancesSave(d *schema.ResourceData, instances []sdkuads.ServiceInfo) error {
	var ids []string
