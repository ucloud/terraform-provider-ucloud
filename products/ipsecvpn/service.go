...
func describeVPNGatewayByID(client *ipsecvpn.IPSecVPNClient, vpnGwId string) (*ipsecvpn.VPNGatewayDataSet, error) {
	if vpnGwId == "" {
...
func describeVPNCustomerGatewayByID(client *ipsecvpn.IPSecVPNClient, vpnCusGwId string) (*ipsecvpn.RemoteVPNGatewayDataSet, error) {
	if vpnCusGwId == "" {
...
func describeVPNConnectionByID(client *ipsecvpn.IPSecVPNClient, vpnConnId string) (*ipsecvpn.VPNTunnelDataSet, error) {
	if vpnConnId == "" {
