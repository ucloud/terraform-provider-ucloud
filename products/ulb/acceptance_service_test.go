...
func (client *acceptanceClient) describeLBById(lbID string) (*ulb.ULBSet, error) {
	if lbID == "" {
...
func (client *acceptanceClient) describeVServerById(lbID, listenerID string) (*ulb.ULBVServerSet, error) {
	if listenerID == "" {
...
func (client *acceptanceClient) describeBackendById(lbID, listenerID, backendID string) (*ulb.ULBBackendSet, error) {
	if backendID == "" {
...
func (client *acceptanceClient) describePolicyById(lbID, listenerID, policyID string) (*ulb.ULBPolicySet, error) {
	if policyID == "" {
...
func (client *acceptanceClient) describeLBSSLById(sslID string) (*ulb.ULBSSLSet, error) {
	if sslID == "" {
...
func (client *acceptanceClient) describeLBSSLAttachmentById(sslID, lbID, vserverID string) (*ulb.SSLBindedTargetSet, error) {
	request := client.ulbconn.NewDescribeSSLRequest()
	request.SSLId = ucloud.String(sslID)
	response, err := client.ulbconn.DescribeSSL(request)
	if err != nil {
...
func (client *acceptanceClient) describeVServerByOneId(listenerID string) (*ulb.ULBVServerSet, string, error) {
	request := client.ulbconn.NewDescribeVServerRequest()
...
func (client *acceptanceClient) getLBIdFromVServerId(listenerID string) (string, error) {
	request := client.ulbconn.NewDescribeULBRequest()
...
func (client *acceptanceClient) describeBackendByOneId(backendID string) (*ulb.ULBBackendSet, string, string, error) {
...
func (client *acceptanceClient) getLBIdAndVServerIdFromBackendId(backendID string) (string, string, error) {
	request := client.ulbconn.NewDescribeULBRequest()
	var ulbSets []ulb.ULBSet
	const limit = 100
	for offset := 0; ; offset += limit {
...
func (client *acceptanceClient) describePolicyByOneId(policyID string) (*ulb.ULBPolicySet, string, string, error) {
...
func (client *acceptanceClient) getLBIdAndVServerIdFromPolicyId(policyID string) (string, string, error) {
	request := client.ulbconn.NewDescribeULBRequest()
	var ulbSets []ulb.ULBSet
	const limit = 100
	for offset := 0; ; offset += limit {
...
func (client *acceptanceClient) describeFirewallByIdAndType(resourceID, resourceType string) (*unet.FirewallDataSet, error) {
